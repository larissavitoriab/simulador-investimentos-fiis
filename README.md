...
## ✅ Como Usar
1. Faça o download da planilha diretamente aqui: [Baixar Planilha de Simulação de Investimentos em FIIs](https://github.com/seu-usuario/simulador-investimentos-fiis/blob/main/Simulacao_Investimento_FIIs.xlsx).
